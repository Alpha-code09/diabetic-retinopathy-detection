...
function ResNetClassifier() {
  ...
  const detectDisease = async () => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:8080/api/resnet-classifier', {
        method: 'POST',
        headers: {
          ...getAuthHeaders(),
        },
      ...
      <div className="max-w-6xl mx-auto py-12 px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Deep residual learning for accurate diabetic retinopathy classification using advanced convolutional networks
          </p>
          <div className="flex justify-center items-center space-x-6 mt-6">
            <div className="flex items-center space-x-2 bg-blue-100 dark:bg-blue-900/30 px-4 py-2 rounded-full">
              <span className="text-blue-600 dark:text-blue-400">🎯</span>
              <span className="text-sm font-medium text-blue-800 dark:text-blue-200">High Precision</span>
            </div>
            <div className="flex items-center space-x-2 bg-green-100 dark:bg-green-900/30 px-4 py-2 rounded-full">
              <span className="text-green-600 dark:text-green-400">⚡</span>
              <span className="text-sm font-medium text-green-800 dark:text-green-200">Fast Analysis</span>
            </div>
            <div className="flex items-center space-x-2 bg-purple-100 dark:bg-purple-900/30 px-4 py-2 rounded-full">
              <span className="text-purple-600 dark:text-purple-400">🧠</span>
              <span className="text-sm font-medium text-purple-800 dark:text-purple-200">Deep Learning</span>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    or <span className="text-green-600 dark:text-green-400 font-medium">browse files</span> to upload
                  </p>
                </div>
        ...
        {result && (
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 border border-gray-100 dark:border-gray-700">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-300">ResNet-50 classification complete</p>
            </div>
                ...
                {result.error ? (
                  ...
                  <div className="text-center mb-6">
                    ...
                    <div className={`text-sm font-medium ${
                      ...
                      Confidence: {typeof result.confidence === 'number' ? `${(result.confidence * 100).toFixed(2)}%` : 'N/A'}
                    </div>
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-900 dark:text-white">{typeof result.confidence === 'number' ? `${(result.confidence * 100).toFixed(2)}%` : 'N/A'}</span>
                    </div>
                    <div className="flex justify-between">
