  ...
  const detectDisease = async () => {
    ...
    reader.onload = async () => {
      ...
      try {
        ...
        const response = await fetch('http://localhost:3001/api/cnn-retinanet', {
          method: 'POST',
          headers: {
      ...
      <div className="max-w-6xl mx-auto py-12 px-6">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-5xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-4">
            CNN RetinaNet Analysis
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Advanced vessel segmentation using Convolutional Neural Networks for precise diabetic retinopathy detection
          </p>
          <div className="flex justify-center items-center space-x-6 mt-6">
            <div className="flex items-center space-x-2 bg-green-100 dark:bg-green-900/30 px-4 py-2 rounded-full">
              <span className="text-green-600 dark:text-green-400">⚡</span>
              <span className="text-sm font-medium text-green-800 dark:text-green-200">Fast Processing</span>
            </div>
            <div className="flex items-center space-x-2 bg-blue-100 dark:bg-blue-900/30 px-4 py-2 rounded-full">
              <span className="text-blue-600 dark:text-blue-400">🎯</span>
              <span className="text-sm font-medium text-blue-800 dark:text-blue-200">High Accuracy</span>
            </div>
            <div className="flex items-center space-x-2 bg-purple-100 dark:bg-purple-900/30 px-4 py-2 rounded-full">
              <span className="text-purple-600 dark:text-purple-400">🔬</span>
              <span className="text-sm font-medium text-purple-800 dark:text-purple-200">Vessel Segmentation</span>
            </div>
          </div>
        </div>
        ...
        {result && (
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 border border-gray-100 dark:border-gray-700">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-300">CNN RetinaNet processing complete</p>
            </div>
